      ...
      <div id="wd-dashboard-courses">
        ...
        <div className="wd-dashboard-course">
          <Link href="/Courses/2345" className="wd-dashboard-course-link">
            ...
            <div>
              <h5> CS2345 NLP </h5>
              <p className="wd-dashboard-course-title">NLP Engineer</p>
              <button> Go </button>
            </div>
          </Link>
        </div>
        ...
        <div className="wd-dashboard-course">
          <Link href="/Courses/5678" className="wd-dashboard-course-link">
            ...
            <div>
              ...
              <p className="wd-dashboard-course-title">Database Engineer</p>
              <button> Go </button>
            </div>
          </Link>
        </div>
        <div className="wd-dashboard-course">
          <Link href="/Courses/6789" className="wd-dashboard-course-link">
            ...
            <div>
              ...
              <p className="wd-dashboard-course-title">Cloud Engineer</p>
              <button> Go </button>
            </div>
          </Link>
        </div>
        <div className="wd-dashboard-course">
          <Link href="/Courses/7890" className="wd-dashboard-course-link">
            <Image
              ...
              width={200}
              height={150}
              alt="Aritifical Intelligence Course"
            />
            <div>
